...
class VerifyOtp extends Component {
    ...
    VerifyUser=()=>{
         const email=this.props.route.location.state.data

        axios({
            url: process.env.API_URL + process.env.API_VERSION + '/user/verifyotp/',
            method: 'PUT',
            data: {
                email: email,
                authOTP: this.state.otpe,
            },
        }).then((res) => {
                            ...
                            <div className={classes.paper} elevation={0}>
                                ...
                                <Grid item xs className={classes.mT30}>
                                    <Typography component="h5" variant="h5" className={classes.signupLabel} align="center" >
                                        Enter OTP received in registered mobile/email *188******66 /{email}
                                    </Typography>
                                </Grid>
                                                ...
                                                InputProps={{
                                                    endAdornment: (
                                                        ...
                                                        <OtpInput
                                                            ...
                                                            onChange={this.handleChangeOtpe}
                                                            numInputs={6}
                                                            otpType="number"
                                                            disabled={false}
                                                            //separator={<span>-</span>}
